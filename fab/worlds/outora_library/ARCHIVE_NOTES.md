...
The following files from `fab/outora-library/blender/` can be archived to external storage:
...
# Move old versions
mv fab/outora-library/blender/outora_library_v0.*.blend ~/Archives/outora-library-blend-files/
mv fab/outora-library/blender/Gothic_Kit_for_sketchfab.blend ~/Archives/outora-library-blend-files/
mv fab/outora-library/blender/gothic_library_2_cycles.blend ~/Archives/outora-library-blend-files/
...
- `fab/outora-library/blender/*.py` - Original scripts (referenced by stage scripts until Phase 7 migration)
- `fab/outora-library/src/outora_library/*.py` - Helper modules

### Post-Migration Cleanup

After full migration (Phase 7 complete):
1. Deprecate `fab/outora-library/` directory
