...
skills/development/cyntra-rollout-builder.py .workcells/wc-42-20251220/

# Validate schema
skills/development/cyntra-schema-validator.py rollout.json rollout
...
# Add skills to path
sys.path.insert(0, str(Path("skills/development")))
...
skills/development/cyntra-schema-validator.py /tmp/test.json rollout
```

## Documentation

- See individual skill YAML files for detailed input/output specifications
- See `skills/README.md` for library overview
