...
def test_gate_fails_fast_on_draco_when_decode_disabled(tmp_path: Path) -> None:
    from dev_kernel.fab.godot import (
        GodotConfig,
        GodotGateConfig,
...
def test_gate_reports_unsupported_extension_from_import_log(tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
    from dev_kernel.fab import godot as godot_mod
    from dev_kernel.fab.godot import GodotGateConfig, run_godot_harness
...
def test_gate_reports_draco_decode_failed_when_blender_missing(
    ...
    from dev_kernel.fab import render as render_mod
    from dev_kernel.fab.godot import (
        GodotGateConfig,
        KHR_DRACO_MESH_COMPRESSION,
        run_godot_harness,
...
def test_ensure_web_compatibility_renderer_patches_project_file(tmp_path: Path) -> None:
    from dev_kernel.fab.godot import _ensure_web_compatibility_renderer
