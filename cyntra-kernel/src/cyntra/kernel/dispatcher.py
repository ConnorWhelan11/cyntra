...
from cyntra.hooks import HookRunner, HookTrigger, HookContext
...
class Dispatcher:
    ...
    def __init__(self, config: KernelConfig, controller: ExplorationController | None = None) -> None:
        self.config = config
    ...
    def dispatch(
        ...
        timeout_override = planner.get("timeout_seconds_override") if isinstance(planner, dict) else None
            ...
            if success:
                ...
                if hook_results:
                    proof.review = {
                        ...
                        "recommendations": [
                            r for h in hook_results for r in h.recommendations
                        ],
    ...
    def _build_manifest(
        ...
        if "asset:world" in tags:
            ...
            dk_gates = getattr(issue, "dk_quality_gates")
