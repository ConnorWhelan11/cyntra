...
def _extract_predicted_tuple(action: dict[str, Any]) -> tuple[str, BudgetBin, BudgetBin, BudgetBin] | None:
...
class KernelPlannerIntegration:
    ...
    def _predict_action(self, planner_input: dict[str, Any]) -> tuple[dict[str, Any] | None, str | None]:
        if self.mode == "off":
