...
def train_mlp(
    *,
    ...
    (out_dir / "vocab.json").write_text(json.dumps(vocab.to_dict(), indent=2, sort_keys=True) + "\n")
    ...
    *,
    ...
    for epoch in range(config.epochs):
        ...
        for batch in _batches(train_items, config.batch_size):
            ...
            swarm_logits, candidates_logits, minutes_logits, iterations_logits = model.forward_tbptt(
                input_ids,
                attention_mask,
