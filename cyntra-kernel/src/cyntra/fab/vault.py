...
class VaultRegistry:
    ...
    def get_addon(self, addon_id: str) -> Optional[AddonEntry]:
    ...
    def _load_addon_manifest(self, catalog_entry: dict[str, Any]) -> Optional[AddonEntry]:
    ...
    def _load_template_manifest(self, catalog_entry: dict[str, Any]) -> Optional[TemplateEntry]:
    ...
    def list_addons(self, kind: Optional[str] = None) -> list[dict[str, Any]]:
    ...
    def list_templates(self, kind: Optional[str] = None) -> list[dict[str, Any]]:
...
_global_registry: Optional[VaultRegistry] = None


def get_vault_registry(vault_root: Optional[Path] = None) -> VaultRegistry:
...
def get_addon(addon_id: str) -> Optional[AddonEntry]:
    """Get addon by ID."""
    return get_vault_registry().get_addon(addon_id)


def get_template(template_id: str) -> Optional[TemplateEntry]:
    """Get template by ID."""
