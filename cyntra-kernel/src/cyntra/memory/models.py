...
class AgentMemory(BaseModel):
    ...
    happens_at: Optional[datetime] = None  # When event occurred (for temporal context)
    ...
    runs_at_creation: Optional[int] = None
    runs_at_last_access: Optional[int] = None

    # Agent-specific fields
    run_id: Optional[str] = None  # Run that created this memory
    world_id: Optional[str] = None  # Fab World context (for scope=world)
