...
class MemoryDB:
    ...
    def add_summary(
        ...
        conn.execute("""
            ...
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)
        """, (
            summary_id, session_id, summary_type, content,
    ...
    def get_context_for_injection(
        ...
        if domain:
            obs_rows = conn.execute("""
                ...
                LIMIT ?
            """, (domain, max_observations)).fetchall()
        else:
            obs_rows = conn.execute("""
