...
class MemoryHooks:
    ...
    def _format_context_for_injection(self, context: dict[str, Any]) -> dict[str, Any]:
        ...
        for summary in context.get("summaries", []):
            ...
            if anti_patterns:
                try:
                    ap_list = json.loads(anti_patterns) if isinstance(anti_patterns, str) else anti_patterns
    ...
    def add_decision(self, decision: str, rationale: str, file_refs: list[str] | None = None) -> None:
