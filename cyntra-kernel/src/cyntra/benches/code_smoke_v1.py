...
def _case(
    *,
    ...
    return {
        ...
        "acceptance_criteria": [
            f"Tests pass: `pytest benches/code_smoke_v1/tests -q -k {test_k}`",
        ],
        "context_files": [
            "benches/code_smoke_v1/tasks.py",
            "benches/code_smoke_v1/tests/test_cases.py",
        ],
        ...
        "quality_gates": {
            "test": f"pytest benches/code_smoke_v1/tests -q -k {test_k}",
        },
    }
...
BENCH: dict[str, Any] = {
    ...
    "cases": [
        _case(
            ...
            description="""
Implement `add_ints(a: int, b: int) -> int` in `benches/code_smoke_v1/tasks.py`.
...
""",
        ...
        _case(
            ...
            description="""
Implement `clamp_int(value: int, low: int, high: int) -> int` in `benches/code_smoke_v1/tasks.py`.
...
""",
        ...
        _case(
            ...
            description="""
Implement `normalize_whitespace(text: str) -> str` in `benches/code_smoke_v1/tasks.py`.
...
""",
        ...
        _case(
            ...
            description="""
Implement `slugify(text: str) -> str` in `benches/code_smoke_v1/tasks.py`.
...
""",
        ...
        _case(
            ...
            description="""
Implement `parse_kv_pairs(text: str) -> dict[str, str]` in `benches/code_smoke_v1/tasks.py`.
...
""",
        ...
        _case(
            ...
            description="""
Implement `safe_divide(a: float, b: float) -> float | None` in `benches/code_smoke_v1/tasks.py`.
...
""",
        ...
        _case(
            ...
            description="""
Implement `chunk_list(items: list[int], size: int) -> list[list[int]]` in `benches/code_smoke_v1/tasks.py`.
...
""",
        ...
        _case(
            ...
            description="""
Implement `unique_preserve_order(items: list[str]) -> list[str]` in `benches/code_smoke_v1/tasks.py`.
...
""",
        ...
        _case(
            ...
            description="""
Implement `is_valid_email_basic(email: str) -> bool` in `benches/code_smoke_v1/tasks.py`.
...
""",
        ...
        _case(
            ...
            description="""
Implement `format_bytes(num_bytes: int) -> str` in `benches/code_smoke_v1/tasks.py`.
...
""",
        ...
        _case(
            ...
            description="""
Implement `parse_csv_line(line: str) -> list[str]` in `benches/code_smoke_v1/tasks.py`.
...
""",
        ...
        _case(
            ...
            description="""
Implement `median_ints(values: list[int]) -> float` in `benches/code_smoke_v1/tasks.py`.
...
""",
        ...
        _case(
            ...
            description="""
Implement `rolling_sum(values: list[int]) -> list[int]` in `benches/code_smoke_v1/tasks.py`.
...
""",
        ...
        _case(
            ...
            description="""
Implement `coalesce(*values: object) -> object | None` in `benches/code_smoke_v1/tasks.py`.
...
""",
        ...
        _case(
            ...
            description="""
Implement `invert_dict_unique(mapping: dict[str, str]) -> dict[str, str]` in `benches/code_smoke_v1/tasks.py`.
...
""",
        ...
        _case(
            ...
            description="""
Implement `json_pointer_get(obj: object, pointer: str) -> object` in `benches/code_smoke_v1/tasks.py`.
...
""",
        ...
        _case(
            ...
            description="""
Implement `stable_sort_by_key(items: list[dict[str, int]], key: str) -> list[dict[str, int]]` in `benches/code_smoke_v1/tasks.py`.
...
""",
        ...
        _case(
            ...
            description="""
Implement `parse_duration_seconds(text: str) -> int` in `benches/code_smoke_v1/tasks.py`.
...
""",
        ...
        _case(
            ...
            description="""
Implement `redact_secrets(text: str, secrets: list[str]) -> str` in `benches/code_smoke_v1/tasks.py`.
...
""",
        ...
        _case(
            ...
            description="""
Implement `longest_common_prefix(values: list[str]) -> str` in `benches/code_smoke_v1/tasks.py`.
