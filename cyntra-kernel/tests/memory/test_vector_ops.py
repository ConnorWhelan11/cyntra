...
class TestVectorOps:
    ...
    def test_init_defaults(self):
        ...
        from cyntra.memory.vector_ops import VectorOps, DEFAULT_MODEL
    ...
    async def test_generate_embedding_local(self, vector_ops):
        ...
        assert "test text" not in vector_ops._cache or vector_ops._cache[vector_ops._cache_key("test text")] == result
    ...
    async def test_batch_embeddings_with_cache(self, vector_ops):
        ...
        with patch.object(
            vector_ops, '_batch_embed_local',
            new=AsyncMock(return_value=[[0.2] * 768])
        ):
