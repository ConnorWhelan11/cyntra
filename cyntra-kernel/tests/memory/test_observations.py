...
class TestObservationType:
    ...
    def test_cyntra_extension_types(self):
        ...
        cyntra_types = [
            "gate_result", "tool_sequence",
            "trap_warning", "repair_strategy"
        ]
...
class TestConcept:
    ...
    def test_all_concepts(self):
        ...
        expected = {
            "discovery", "problem-solution", "pattern",
            "anti-pattern", "workflow", "configuration"
        }
...
class TestObservationFactories:
    ...
    def test_from_tool_use_edit(self):
        ...
        from cyntra.memory.observations import Observation, ObservationType, Concept
    ...
    def test_from_tool_use_read(self):
        ...
        from cyntra.memory.observations import Observation, Concept
