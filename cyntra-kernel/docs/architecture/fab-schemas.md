...
All Fab artifacts use JSON Schema (draft-07) for validation. Schemas live in `cyntra-kernel/schemas/fab/` and follow existing kernel conventions.
...
**File**: `cyntra-kernel/schemas/fab/asset-proof.schema.json`
...
**File**: `cyntra-kernel/schemas/fab/critic-report.schema.json`
...
**File**: `cyntra-kernel/schemas/fab/gate-verdict.schema.json`
...
**File**: `cyntra-kernel/schemas/fab/run-manifest.schema.json`
