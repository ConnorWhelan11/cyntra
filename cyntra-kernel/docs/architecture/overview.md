...
| ---------------------- | --------------------------------------------------------- | ---------------------------------------------- |
| **Cyntra Kernel**         | Orchestration, scheduling, verification, state management | CLI: `cyntra run`, config YAML             |
