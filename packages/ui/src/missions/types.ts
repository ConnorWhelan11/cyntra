...
export type MissionEvent =
  ...
  | { type: "mission/abort"; runId: MissionRunId; at: number; actor?: MissionActor; reason?: string }
  | { type: "mission/enterPhase"; runId: MissionRunId; at: number; phase: MissionPhase }
  | { type: "mission/complete"; runId: MissionRunId; at: number; actor?: MissionActor; debrief?: MissionDebrief }
  ...
  | { type: "tool/event"; runId: MissionRunId; at: number; toolId: MissionToolId; name: string; data?: Record<string, unknown> }
...
export interface MissionPodSyncAdapter {
  ...
  getParticipants?: (runId: MissionRunId) => Promise<Array<{ userId: string; displayName?: string }>>;
}
