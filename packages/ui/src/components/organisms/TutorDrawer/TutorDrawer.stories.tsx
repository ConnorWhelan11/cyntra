...
const mockMessages: ChatMessage[] = [
  {
    ...
    type: "agent",
    content:
      "Hello! I'm your AI Study Tutor. How can I help you with your MCAT preparation today?",
...
const TutorDrawerWithState: React.FC<
  Partial<React.ComponentProps<typeof TutorDrawer>>
> = (args) => {
    ...
    <div className="min-h-screen bg-background p-8">
      <div className="max-w-md mx-auto space-y-4">
        ...
        <p className="text-muted-foreground">
          Click the button below to open the AI tutor drawer and start a
          conversation.
        </p>
