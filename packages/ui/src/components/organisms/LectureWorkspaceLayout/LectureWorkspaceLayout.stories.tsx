...
import { LectureWorkspaceLayout, WorkspaceLayoutMode, WorkspaceFocusPanel } from "./LectureWorkspaceLayout";
      ...
      <div className="flex h-full flex-col rounded-lg border border-border/40 bg-card/60 p-4">
        ...
        <div className="flex-1 space-y-2 overflow-y-auto">
          <div className="rounded bg-card/80 p-2 text-xs">
            ...
            <span className="text-muted-foreground">Can someone explain the Frank-Starling mechanism?</span>
          </div>
          <div className="rounded bg-card/80 p-2 text-xs">
            <span className="font-medium text-purple-400">Bob:</span>{" "}
            <span className="text-muted-foreground">It's about preload and stroke volume relationship</span>
          </div>
          <div className="rounded bg-card/80 p-2 text-xs">
