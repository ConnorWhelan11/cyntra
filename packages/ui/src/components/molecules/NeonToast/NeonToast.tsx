...
const toastPresets = {
  correct: {
    icon: CheckCircle2,
    className:
      "border-emerald-neon/40 bg-emerald-neon/10 text-emerald-neon shadow-neon-emerald/30",
  ...
  streak: {
    icon: Flame,
    className:
      "border-cyan-neon/40 bg-cyan-neon/10 text-cyan-neon shadow-neon-cyan/30",
    iconClassName: "text-cyan-neon",
  },
  achievement: {
    icon: Trophy,
    className:
      "border-magenta-neon/40 bg-magenta-neon/10 text-magenta-neon shadow-neon-magenta/30",
...
function CustomToast({
  ...
  return (
    ...
    >
      ...
      {shouldAnimate &&
        (type === "correct" || type === "streak" || type === "achievement") && (
          <motion.div
