          ...
          return (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                {status === "active" && step.completion.kind === "time" && stepState?.elapsedSeconds !== undefined && (
                  <div className="mt-2">
                    ...
                    <div className="mt-1 text-[10px] text-muted-foreground">
                      {Math.floor(stepState.elapsedSeconds / 60)}:{(Math.floor(stepState.elapsedSeconds) % 60).toString().padStart(2, "0")} / {Math.floor(step.completion.seconds / 60)}:{(step.completion.seconds % 60).toString().padStart(2, "0")}
                    </div>
                  </div>
                )}
              </div>
