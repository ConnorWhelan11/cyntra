    ...
    >
      ...
      <motion.span
        className={cn(
          ...
          active
            ? styles.iconActive
            : cn("text-slate-500/80", styles.iconHover),
          iconWrapperClassName
        )}
      ...
      <motion.span
        ...
        className={cn(
          ...
          active
            ? styles.labelActive
            : cn("text-slate-400/90", styles.labelHover),
          ...
          >
            <div
              className={cn(
                ...
                hasActivity
                  ? cn(styles.orb, "opacity-100")
                  : "bg-slate-600/30 opacity-40"
              )}
            />
            {hasActivity && (
              <div
