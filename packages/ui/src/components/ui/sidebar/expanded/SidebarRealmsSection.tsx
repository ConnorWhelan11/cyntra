...
export const SidebarRealmsSection = ({
  children,
  className,
  ...
  if (!open && !isAnimating) {
    return (
      <div className={cn("flex flex-col gap-1 overflow-visible", className)}>
        {children}
      </div>
    );
  }
  ...
  return (
    <motion.div
      className={cn(
        "relative flex flex-col gap-2.5 pt-4 mt-2 overflow-visible",
        className
      )}
