...
export const TimelineView: Story = {
  render: () => (
    <InteractiveTodayLens viewMode="timeline" currentTime={timeToday(8, 30)} />
  ),
  parameters: {
    docs: {
      description: {
...
export const RingView: Story = {
  render: () => (
    <InteractiveTodayLens viewMode="ring" currentTime={timeToday(8, 30)} />
  ),
  parameters: {
    docs: {
      description: {
...
export const MorningStartup: Story = {
  render: () => (
    <InteractiveTodayLens viewMode="timeline" currentTime={timeToday(6, 0)} />
  ),
  parameters: {
    docs: {
      description: {
        story:
          "Morning view before the day starts. Glyph greets the user and shows the day ahead.",
      },
    },
  },
};
...
export const MidDayProgress: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Mid-day view showing mixed progress: some done, one skipped, one deferred.",
      },
    },
  },
};
...
export const DayComplete: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Day complete! All blocks are done. Glyph celebrates and prompts for Debrief.",
      },
    },
  },
};
...
export const EmptyDay: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Empty day with no blocks. Shows empty state prompting user to plan.",
      },
    },
  },
};
...
export const RingViewShort: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Ring view with only 3 blocks, showing how the ring adapts to fewer nodes.",
      },
    },
  },
};
...
export const Interactive: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Full interactive demo. Click blocks, toggle views, and explore the Today lens.",
      },
    },
  },
};
...
export const RealTime: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Real-time view using the actual current time. The Now marker updates every minute.",
      },
    },
  },
};
