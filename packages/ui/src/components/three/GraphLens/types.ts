 ...
 */
export interface GraphLensSceneProps
  extends Omit<
    GraphLensProps,
...
export const GLYPH_DIALOGUES: Record<GraphLensMode, string> = {
  overview:
    "This is your whole life graph – everything connected in one place.",
  ...
  switch (mode) {
    ...
    case "shrinkToNow":
      return {
        ...
        highlightedNodeIds: [focusNodeId!, ...highImpactNodeIds].filter(
          Boolean
        ),
        focusedPath: [],
        maxLabels: 0,
