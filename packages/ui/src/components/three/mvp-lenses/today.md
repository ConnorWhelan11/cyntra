...
> **Reuse the existing calendar module at `packages/ui/src/components/calendar` for the Timeline view.**
...
```css
/* packages/ui/src/components/calendar/today-lens-overrides.css */
...
- **Timeline view:** Adapt `CalendarDayView` from `packages/ui/src/components/calendar/views/week-and-day-view/`.
