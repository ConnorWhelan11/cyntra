...
const InteractiveLeaksLens: React.FC<InteractiveLeaksLensProps> = ({
  ...
  const [distractions, setDistractions] =
    useState<DistractionNode[]>(initialDistractions);
...
export const SingleHotLeak: Story = {
  render: () => (
    <InteractiveLeaksLens initialDistractions={minimalDistractions} />
  ),
  parameters: {
    docs: {
      description: {
...
export const Interactive: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Full interactive demo. Toggle leak actions, select duration, confirm suppression.",
      },
    },
  },
};
