...
const Particle = ({ factor, speed, xFactor, yFactor, zFactor }: any) => {
...
export const ParticleField = ({ count = 100, range = 20, color = "#00f0ff" }: ParticleFieldProps) => {
  ...
  return (
    <Instances range={range} limit={count}>
      ...
      <meshStandardMaterial color={color} roughness={0} metalness={0.5} emissive={color} emissiveIntensity={0.5} />
