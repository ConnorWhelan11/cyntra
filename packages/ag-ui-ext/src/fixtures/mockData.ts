...
export const mockQuestions = [
  {
    ...
    choices: ["Protein synthesis", "ATP production", "DNA replication", "Waste removal"],
    correctAnswer: 1,
    explanation:
...
export const mockTutorMessages = [
  ...
  },
  {
    id: "m2",
    type: "user" as const,
    content: "I keep getting confused about when to apply Markovnikov vs anti-Markovnikov rules.",
