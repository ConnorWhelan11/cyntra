...
export const SidebarSection = ({
  ...
  return (
    <motion.div
      ...
      className={cn("flex items-center gap-2 px-2 mt-3 first:mt-0 overflow-hidden", className)}
    >
      {/* Signal bar - grows from 0 height */}
      <motion.div
        className={cn("w-[3px] rounded-full origin-center", styles.bar, styles.barGlow)}
