...
export const accentColorMap = {
  teal: {
    ...
    shadow: "shadow-[0_0_12px_rgba(20,184,166,0.08)] hover:shadow-[0_0_24px_rgba(20,184,166,0.18)]",
  ...
  violet: {
    ...
    shadow: "shadow-[0_0_12px_rgba(139,92,246,0.08)] hover:shadow-[0_0_24px_rgba(139,92,246,0.18)]",
  ...
  amber: {
    ...
    shadow: "shadow-[0_0_12px_rgba(245,158,11,0.08)] hover:shadow-[0_0_24px_rgba(245,158,11,0.18)]",
  ...
  rose: {
    ...
    shadow: "shadow-[0_0_12px_rgba(244,63,94,0.08)] hover:shadow-[0_0_24px_rgba(244,63,94,0.18)]",
...
export const getLinkAccentStyles = (accent: SidebarAccent) => {
  const accentStyles = {
    ...
    violet: {
      ...
      iconActive: "text-violet-300 drop-shadow-[0_0_8px_rgba(167,139,250,0.55)]",
    ...
    amber: {
      ...
      iconActive: "text-amber-300 drop-shadow-[0_0_8px_rgba(251,191,36,0.55)]",
    ...
    emerald: {
      ...
      iconActive: "text-emerald-300 drop-shadow-[0_0_8px_rgba(52,211,153,0.55)]",
    ...
    rose: {
      ...
      iconActive: "text-rose-300 drop-shadow-[0_0_8px_rgba(251,113,133,0.55)]",
