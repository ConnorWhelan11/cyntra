...
const mockQuestions = [
  {
    ...
    correctAnswerId: "b",
    explanation:
      "PFK-1 catalyzes the committed step of glycolysis and is the main regulatory enzyme.",
  },
  {
    id: "q2",
    ...
    correctAnswerId: "c",
    explanation:
      "The ETC pumps protons across the inner mitochondrial membrane, creating the gradient used by ATP synthase.",
  },
  {
    id: "q3",
    ...
    correctAnswerId: "b",
    explanation:
      "The Frank-Starling mechanism describes how increased ventricular filling (preload) leads to increased stretch and stronger contraction.",
  },
];
    ...
    <div className="practice-question-tool flex h-full flex-col p-4">
          ...
          return (
            <button
              ...
              className={cn(
                ...
                !submitted &&
                  !isSelected &&
                  "border-border/40 bg-card/40 hover:border-cyan-neon/30",
      ...
      <div className="mt-auto flex items-center justify-between">
        ...
        <div className="flex gap-2">
          {!submitted ? (
            <GlowButton glow="low" size="sm" onClick={handleSubmit} disabled={!selectedId}>
              Submit
            </GlowButton>
