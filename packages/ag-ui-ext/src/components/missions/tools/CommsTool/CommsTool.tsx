...
const mockMessages = [
  {
    ...
    userId: "u2",
    name: "Alex K.",
    text: "Ready to dive into Frank-Starling?",
    time: "2:32 PM",
  },
  {
    id: "m2",
    userId: "u1",
    name: "You",
    text: "Let's do it! Should we start with the basic curve?",
    time: "2:33 PM",
  },
  {
    id: "m3",
    userId: "u2",
    name: "Alex K.",
    text: "Yes, I'll draw the axes. You handle the labeling.",
    time: "2:33 PM",
  },
];
    ...
    <div className="comms-tool flex h-full flex-col">
        ...
        {mockParticipants.map((p) => (
          <div
            ...
            className={cn(
              ...
              p.isOnline
                ? "bg-emerald-neon/10 text-emerald-neon"
      ...
      <div className="flex-1 min-h-0 overflow-y-auto p-4 space-y-3">
        {messages.map((msg) => (
          <div
            key={msg.id}
            className={cn("flex flex-col gap-1", msg.userId === "u1" ? "items-end" : "items-start")}
          >
