...
const sampleLectureNotes: any[] = [
  ...
  {
    type: "paragraph",
    content: [{ type: "text", text: "Three main types: dilated, hypertrophic, restrictive." }],
  },
];
...
const sampleStreamContent: LectureSegment[] = [
  {
    ...
    timestamp: 120,
    type: "insight",
    content: "Key distinction: systolic vs diastolic dysfunction",
  },
  { id: "2", timestamp: 180, type: "question", content: "What are the genetic markers for HCM?" },
  {
    ...
    timestamp: 240,
    type: "note",
    content: "Treatment: beta-blockers, CCBs, avoid dehydration",
  },
];
    ...
    useEffect(() => {
      ...
      const addSegment = setInterval(() => {
        const newSegment: LectureSegment = {
          ...
          type: ["insight", "note", "question"][
            Math.floor(Math.random() * 3)
          ] as LectureSegment["type"],
