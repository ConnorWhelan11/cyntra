...
export const WithPrefixes: Story = {
  render: () => (
    <div className="flex flex-wrap gap-3 items-center justify-center">
      <StatBadge variant="xp" prefix="+" value={500} suffix=" XP" glow="subtle" />
...
export const AnimatedValues: Story = {
  render: () => (
    <div className="flex flex-wrap gap-3 items-center justify-center">
      <StatBadge variant="xp" value={1250} suffix=" XP" animateValue glow="subtle" />
      <StatBadge variant="streak" value={22} suffix=" days" animateValue glow="subtle" />
      <StatBadge variant="score" value={95} suffix="%" animateValue glow="subtle" />
    </div>
  ),
};
...
export const ReducedMotion: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Demonstrates how badges behave with animations disabled for accessibility.",
      },
    },
  },
};
...
export const Interactive: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    // Check badge content
    if (!badge.textContent?.includes("2500") && !badge.textContent?.includes("2.5K")) {
...
export const GameDashboard: Story = {
  render: () => (
    <div className="p-6 bg-card/40 backdrop-blur-sm border border-border/40 rounded-lg space-y-4">
      <h3 className="text-lg font-semibold text-foreground mb-4">Player Stats</h3>
      ...
      <div className="pt-2 border-t border-border/20">
        <h4 className="text-sm font-medium text-muted-foreground mb-2">Recent Achievements</h4>
        <div className="flex flex-wrap gap-2">
          <StatBadge variant="achievement" value="Speed Demon" size="sm" glow="subtle" />
          <StatBadge variant="achievement" value="Perfect Score" size="sm" glow="subtle" />
          <StatBadge variant="achievement" value="Consistency" size="sm" glow="subtle" />
        </div>
      </div>
    </div>
  ),
