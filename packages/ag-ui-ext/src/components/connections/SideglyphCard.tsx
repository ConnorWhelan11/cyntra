        ...
        <div className="p-6">
          ...
          <div className="mb-4 flex items-start justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-display text-base font-semibold text-white">Sideglyph</h3>
                <p className="text-xs font-medium text-slate-500">Browser Extension</p>
              </div>
            </div>
            {/* Status Indicator */}
          ...
          <p className="mb-6 text-sm leading-relaxed text-slate-300 group-hover:text-white transition-colors">
            Turn any tab into a mission. Capture pages, threads, and docs and we’ll weave them into
            your Out-of-Scope universe.
          </p>
