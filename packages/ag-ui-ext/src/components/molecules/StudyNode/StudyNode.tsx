...
const studyNodeVariants = cva("relative flex flex-col items-center cursor-pointer group", {
  variants: {
    variant: {
      default: "",
      featured: "z-10",
  ...
  "relative flex items-center justify-center rounded-full border-2 transition-all duration-300 overflow-hidden",
  {
    variants: {
      status: {
        ...
        available: "bg-background border-cyan-neon/60 text-cyan-neon shadow-neon-cyan/40",
        "in-progress":
          "bg-cyan-neon/10 border-cyan-neon text-cyan-neon shadow-neon-cyan animate-soft-glow",
        completed: "bg-emerald-neon/10 border-emerald-neon text-emerald-neon shadow-neon-emerald",
...
export function StudyNode({
  ...
  return (
    <div className={cn(studyNodeVariants({ variant, size }), className)} {...props}>
          ...
          >
            ...
            >
              ...
              {prerequisites && prerequisites.length > 0 && (
                <div className="space-y-2">
                  <h4 className="text-xs font-medium text-foreground">Prerequisites</h4>
              ...
              {objectives && objectives.length > 0 && (
                <div className="space-y-2">
                  <h4 className="text-xs font-medium text-foreground">Learning Objectives</h4>
                  <ul className="space-y-1">
              ...
              {onStart && status !== "locked" && status !== "completed" && (
                <div className="pt-2 border-t border-border/20">
                  <GlowButton
                    ...
                    className="w-full"
                  >
                    {status === "in-progress" ? "Continue" : "Start"} Study Session
                  </GlowButton>
                </div>
              )}
            </motion.div>
      ...
      >
        <p className="text-xs font-medium text-foreground truncate max-w-24">{topic}</p>
