  ...
  "relative p-4 rounded-lg border backdrop-blur-sm transition-all duration-200",
  {
    variants: {
      variant: {
        ...
        explanation: "bg-emerald-neon/5 border-emerald-neon/30 shadow-neon-emerald/10",
        warning: "bg-yellow-500/5 border-yellow-500/30",
        insight: "bg-magenta-neon/5 border-magenta-neon/30 shadow-neon-magenta/10",
      },
      size: {
        default: "p-4",
        compact: "p-3",
    ...
    >
      ...
      >
        ...
        {chartData && chartData.length > 0 && (
          ...
          >
            <h4 className="text-xs font-medium text-foreground">Data Overview</h4>
            <div className="space-y-1">
              ...
              <div className="text-center">
                {flashcardData.flipped ? (
                  <div className="space-y-2">
                    ...
                    <div className="text-lg font-medium">{flashcardData.back}</div>
                  </div>
                ) : (
                  <div className="space-y-2">
                    <div className="text-sm text-muted-foreground">Question</div>
                    <div className="text-lg font-medium">{flashcardData.front}</div>
                  </div>
                )}
              </div>
            </div>
