...
import { CheckCircle2, ChevronRight, Circle, Clock, Target, Trophy, Zap } from "lucide-react";
  ...
  "relative group p-4 rounded-lg border transition-all duration-200 cursor-pointer overflow-hidden",
  {
    variants: {
      variant: {
        ...
        completed: "bg-emerald-neon/5 border-emerald-neon/30 shadow-neon-emerald/10",
...
export function QuestCard({
  ...
  return (
    <motion.div
      className={cn(questCardVariants({ variant: finalVariant, size }), className)}
        ...
        <div className="relative z-10">
          ...
          <div className="h-1.5 bg-border/40 rounded-full overflow-hidden">
            <motion.div
              ...
              initial={shouldAnimate ? { width: 0 } : { width: `${progress * 100}%` }}
