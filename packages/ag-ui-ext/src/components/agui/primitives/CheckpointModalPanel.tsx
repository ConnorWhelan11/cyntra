    ...
    >
      <div className="flex items-start justify-between gap-3">
        <div>
          ...
          <h2 className="mt-2 text-lg font-semibold text-foreground">{panel.props.title}</h2>
        </div>
        <Button
          variant="ghost"
          size="icon"
      ...
      <p className="mt-4 whitespace-pre-wrap text-sm text-muted-foreground">{panel.props.body}</p>
