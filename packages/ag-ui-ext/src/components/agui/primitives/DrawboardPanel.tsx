  ...
  return (
    <div className={cn("rounded-2xl border border-border/40 bg-card/40 p-5", className)}>
      <div className="flex items-start justify-between gap-3">
        <div>
          <p className="text-[10px] uppercase tracking-[0.22em] text-muted-foreground">drawboard</p>
          <p className="mt-2 text-sm font-medium text-foreground">{panel.title ?? "Drawboard"}</p>
        </div>
