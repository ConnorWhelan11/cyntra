...
import { Award, Calendar, ChevronRight, Clock, Play, Target, TrendingUp, Zap } from "lucide-react";
import * as React from "react";
import { GlowButton } from "../../atoms/GlowButton";
import { HUDProgressRing } from "../../atoms/HUDProgressRing";

const dashboardHeroVariants = cva("relative w-full py-12 px-6 overflow-hidden", {
  variants: {
    variant: {
      default: "bg-gradient-to-br from-background via-cyan-neon/5 to-emerald-neon/5",
...
export function DashboardHero({
  ...
  return (
    <section className={cn(dashboardHeroVariants({ variant, size }), className)} {...props}>
      {/* Background Elements */}
              ...
              {finalStats.map((stat, index) => (
                ...
                >
                  <div className="flex items-center justify-center mb-2">
                    {stat.icon && <div className="text-muted-foreground mr-2">{stat.icon}</div>}
