...
import { Bot, Clock, Mic, MicOff, Paperclip, Send, User, X } from "lucide-react";
            ...
            <div className="border-t border-border/40 p-4">
              <div className="space-y-3">
                  ...
                  <div className="absolute right-2 top-2 flex gap-1">
                    {voiceEnabled && (
                      <GlowButton
                        ...
                        className={cn("h-6 w-6 p-0", isRecording && "text-destructive")}
                      >
                ...
                <div className="flex items-center justify-between text-xs text-muted-foreground">
                  <span>{loading ? "Sending..." : agentTyping ? "AI is typing..." : "Ready"}</span>
