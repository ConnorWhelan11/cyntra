...
import { Bell, Book, Bot, Menu, MessageSquare, Search, Settings } from "lucide-react";
...
export function Header({
  ...
  type ActionItem = NonNullable<HeaderProps["actionItems"]>[number];
  ...
  const finalActionItems: ActionItem[] = actionItems.length > 0 ? actionItems : defaultActionItems;
          ...
          <div className="flex items-center gap-3">
            {logo || (
              ...
              >
                ...
                <span className="font-semibold text-foreground hidden sm:block">{title}</span>
              </motion.div>
            )}
          </div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={cn(
                    ...
                    searchFocused && "border-cyan-neon/40 ring-1 ring-cyan-neon/20"
                  )}
                />
                {searchValue && (
                  <motion.button
