...
import { BarChart3, Bell, Book, Home, MessageSquare, Settings, Target } from "lucide-react";
...
export const Minimal: Story = {
  args: {
    ...
    showSearch: false,
    title: "Segrada",
    navigationItems: [{ label: "Home", active: true }, { label: "About" }, { label: "Contact" }],
  },
};
...
export const Floating: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Floating header variant with enhanced shadow and border styling.",
      },
    },
  },
};
...
export const OfflineAgent: Story = {
  args: {
    ...
    showAgentOrb: true,
    showSearch: true,
    navigationItems: [{ label: "Dashboard", active: true }, { label: "Practice" }],
  },
};
...
export const Compact: Story = {
  args: {
    ...
    showAgentOrb: true,
    showSearch: true,
    navigationItems: [{ label: "Home", active: true }, { label: "Study" }, { label: "Test" }],
  },
};
...
export const Expanded: Story = {
  args: {
    ...
    showAgentOrb: true,
    showSearch: true,
    navigationItems: [{ label: "Dashboard", active: true }, { label: "Analytics" }],
  },
};
