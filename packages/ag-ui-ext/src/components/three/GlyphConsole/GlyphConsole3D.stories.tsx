...
const ConsoleDemo = (props: ComponentProps<typeof GlyphConsole3D>) => {
  return (
...
export const Thinking: Story = {
  ...
  args: {
    ...Default.args,
    glyphState: "thinking",
    recentExchanges: [{ id: "1", role: "user" as const, text: "Analyze my last session." }],
  },
};
...
export const Interactive: Story = {
  render: (args) => {
    ...
    const handleSubmit = (text: string) => {
      setHistory((prev) => [...prev, { id: Date.now().toString(), role: "user", text }]);
      setState("thinking");
      setTyping(false);
