...
const createStep = (id: string, label: string, duration: number, optional = false): HabitStep => ({
  id,
  label,
  duration,
  optional,
...
// Sample templates
const morningRoutine = createTemplate("t1", "Morning Routine", "morning", [
...
const eveningRoutine = createTemplate("t2", "Evening Routine", "evening", [
...
const fridayDebrief = createTemplate(
  ...
  "Friday Debrief",
  "weekly",
  [createStep("s13", "Review", 15), createStep("s14", "Celebrate", 15)],
...
export const Default: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Full habits setup with morning, evening, weekly anchors, and custom routines.",
      },
    },
  },
};
...
export const Interactive: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Full interactive demo. Expand templates, see streaks, delete habits.",
      },
    },
  },
};
