...
export const generateEdges = (nodes: GraphNode[], density: number = 1.2): GraphEdge[] => {
...
const GraphWrapper = (props: any) => {
  const [selected, setSelected] = useState<string | null>(props.selectedNodeId || null);
  ...
  return (
    ...
    >
      ...
      */}
      ...
      <Canvas camera={props.camera || { position: [0, 0, 10], fov: 45 }} dpr={[1, 2]}>
        <Graph3D
          {...props}
          graph={graphToUse}
...
export const GlyphExplainsDestination: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Glyph narrating the destination; shows a path segment leading to the focused node.",
      },
    },
  },
};
...
export const ADHDOverwhelmZoom: Story = {
  ...
  render: (args) => <GraphWrapper {...args} camera={{ position: [0, 0, 7], fov: 60 }} />,
  args: {
...
export const MissionTimelineRing: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Mission as a circular timeline: each hop is a distinct phase in a focus session.",
      },
    },
  },
};
...
export const attentionNodes = [...missionClusterNodes, ...distractionClusterNodes];
...
export const WeavingUpdateDiff: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Nodes spawn, edges re-sew, and the layout shifts as Glyph recomputes your plan.",
      },
    },
  },
};
...
export const RealmPortalPreview: Story = {
  render: (args) => <GraphWrapper {...args} width="w-[260px]" height="260px" hasVignette={true} />,
  args: {
    graph: {
  ...
  parameters: {
    docs: {
      description: {
        story: "A compact, vignetted portal view. Rotates slowly when idle to feel alive.",
      },
    },
  },
};
