...
- **Python implementation**: `kernel/src/cyntra/adapters/telemetry.py`
- **Tauri commands**: `apps/desktop/src-tauri/src/main.rs`
- **UI component**: `apps/desktop/src/WorkcellDetail.tsx`
- **Tests**: `kernel/tests/test_telemetry.py`
