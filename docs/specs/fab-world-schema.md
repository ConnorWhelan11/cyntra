...
publish:
  viewer:
    enabled: true
    paths:
      glb: fab/assets/viewer/assets/exports/outora_library.glb
      game: fab/assets/viewer/assets/games/outora_library/
```
  ...
  "stages": [
    {
      ...
      "status": "success",
      "duration_ms": 1234,
      "outputs": [{ "path": "stages/prepare/prepared.blend", "sha256": "abc123..." }]
    }
  ],
  "final_outputs": [
    {
...
See `docs/guides/migration-guide.md` for migrating existing pipelines to the Fab World system.
