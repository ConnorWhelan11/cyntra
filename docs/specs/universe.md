...
- `docs/specs/cyntra_spec.md`
- `docs/specs/fab-world-system.md`
- `docs/specs/fab-world-schema.md`
- `docs/specs/telemetry.md`
- `docs/guides/universe-evolution-quickstart.md`
...
For Fab Worlds, the concrete definition is `fab/worlds/<world_id>/world.yaml` (see `docs/specs/fab-world-schema.md`).
...
For Fab: gate configs live in `fab/gates/*.yaml` and are executed via Cyntra Fab tooling (see `docs/specs/fab-world-system.md`).
...
- **Telemetry**: `.workcells/*/telemetry.jsonl` (see `docs/specs/telemetry.md`)
...
For Fab Worlds, the “genome” can start as a minimal set of parameters already present in `world.yaml` (see `docs/specs/fab-world-schema.md`), then expand into a dedicated `genome.yaml` once mutation operators are defined.
...
- `world_id`: existing `world.yaml` conventions (see `docs/specs/fab-world-schema.md`)
