...
| Schemas         | `kernel/schemas/cyntra/`                     | JSON schema definitions              |
| Action Space    | `kernel/src/cyntra/planner/action_space.py`  | Action space implementation          |
| Dataset Builder | `kernel/src/cyntra/planner/dataset.py`       | Dataset construction                 |
| Run Summaries   | `kernel/src/cyntra/planner/run_summaries.py` | Run extraction                       |
| Similar Runs    | `kernel/src/cyntra/planner/similar_runs.py`  | History retrieval                    |
