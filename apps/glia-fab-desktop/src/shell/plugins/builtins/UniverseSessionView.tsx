  ...
  if (!session) {
    return (
      <div className="shell-placeholder">
        ...
        <div className="shell-placeholder-text">This world session is not in your local session store.</div>
      </div>
    );
  }
    ...
    <div className="shell-session-view">
      <header className="shell-session-header">
        ...
        <div className="shell-session-meta">
          ...
          <span className="shell-session-meta-item">Updated: {formatTimestamp(session.updatedAt)}</span>
        </div>
      </header>
