...
export function ConstellationLayout({
  ...
  return (
    <div className="constellation-layout">
      ...
      <div className="constellation-canvas-layer">
        {canvas}
      </div>
      ...
      <div className="constellation-ui-layer">
        ...
        <div className="constellation-main">
          {/* Left: Mode Rail */}
          <div className="constellation-rail">
            {modeRail}
          </div>
          ...
          <div
            className={`constellation-inspector ${state.inspectorOpen ? "open" : "closed"}`}
          >
            {inspector}
          </div>
        </div>
        ...
        <div className="constellation-output">
          {outputStream}
        </div>
      </div>
    </div>
