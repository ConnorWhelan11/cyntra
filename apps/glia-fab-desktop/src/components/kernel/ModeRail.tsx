  ...
  return (
    ...
    >
      ...
      {count !== undefined && count > 0 && (
        <span className="mode-rail-button-badge">{count}</span>
      )}
    </button>
  );
}
    ...
    <div className="mode-rail">
      ...
      <div className="mode-rail-section">
        ...
        {toolchains.map((tc) => (
          <FilterChip
            ...
            onClick={() =>
              state.setFilterToolchain(state.filterToolchain === tc ? null : tc)
            }
          />
        ))}
      </div>
      ...
      <div className="mode-rail-section">
        ...
        <FilterChip
          ...
          onClick={() =>
            state.setFilterStatus(state.filterStatus === "running" ? null : "running")
          }
        />
        ...
        <FilterChip
          ...
          onClick={() =>
            state.setFilterStatus(state.filterStatus === "failed" ? null : "failed")
          }
        />
        ...
        <FilterChip
          ...
          onClick={() =>
            state.setFilterStatus(state.filterStatus === "success" ? null : "success")
          }
        />
      </div>
