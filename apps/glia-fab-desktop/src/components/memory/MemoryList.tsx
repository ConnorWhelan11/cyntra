    ...
    return (
      <div className={`h-full flex flex-col items-center justify-center p-8 ${className}`}>
        <div className="relative mb-4">
          ...
          <div className="absolute inset-0 rounded-2xl border border-accent-primary/20 animate-ping" style={{ animationDuration: "3s" }} />
        </div>
        ...
        return (
          <div
            ...
            className={`
              ...
              ${isSelected
                ? "bg-card-selected-bg"
                : "bg-obsidian/30 hover:bg-obsidian/60"
              }
            `}
            style={{
                    ...
                    <div className="relative w-12 h-1 rounded-full bg-slate/50 overflow-hidden">
                      <div
                        ...
                        style={{
                          ...
                          background: memory.importance > 0.7
