...
const MOCK_ASSETS: GalleryAsset[] = [
  {
    ...
    criticScores: { geometry: 0.95, realism: 0.90, alignment: 0.92 },
    gateVerdict: "pass",
  },
  {
    id: "asset-002",
  ...
  },
  {
    ...
    criticScores: { geometry: 0.93, realism: 0.90, alignment: 0.91 },
    gateVerdict: "pass",
  },
  {
    id: "asset-005",
  ...
  },
  {
    ...
    criticScores: { geometry: 0.90, realism: 0.87, alignment: 0.88 },
    gateVerdict: "pass",
  },
  {
    id: "asset-007",
    ...
    criticScores: { geometry: 0.75, realism: 0.70, alignment: 0.72 },
    gateVerdict: "pass",
  },
  {
    id: "asset-008",
    ...
    criticScores: { geometry: 0.50, realism: 0.42, alignment: 0.44 },
    gateVerdict: "fail",
  },
];
...
export function GalleryView2({ activeProject: _activeProject }: GalleryView2Props) {
  ...
  useEffect(() => {
    if (state.stageMode !== "featured" || state.featuredAssets.length <= 1) {
      return;
    }
  ...
  }, [state.stageMode, state.featuredAssets.length, state.nextFeatured]);
