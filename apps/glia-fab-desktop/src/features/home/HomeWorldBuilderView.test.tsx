...
describe("HomeWorldBuilderView", () => {
  ...
  describe("Recent Worlds", () => {
    ...
    it("should call onNavigateToWorld when resuming a world", async () => {
      ...
      const user = userEvent.setup();
      render(<HomeWorldBuilderView onNavigateToWorld={onNavigateToWorld} />);
      ...
      expect(onNavigateToWorld).toHaveBeenCalledWith("world-existing");
    });
  });
