...
const SUGGESTION_CHIPS: SuggestionChip[] = [
  ...
  },
  {
    id: "modern-house",
    label: "Modern house",
    promptText: "A contemporary house with clean lines, large windows, and landscaped garden at golden hour",
    runtime: "three",
    outputs: ["viewer"],
  },
  {
  ...
  },
  {
    id: "workshop",
    label: "Workshop",
    promptText: "A craftsman's workshop filled with tools, workbenches, and materials under warm pendant lights",
    runtime: "three",
    outputs: ["viewer"],
  },
];
