  ...
  return (
    <div className="agent-panel">
      ...
      <div className="agent-panel-header">
        ...
        {isSpeculating && (
          <span className="agent-panel-badge agent-panel-badge--speculate">
            Speculate+Vote
          </span>
        )}
      </div>
            ...
            >
              ...
              >
                <div className="agent-panel-item-info">
                  ...
                  <span className="agent-panel-item-fitness">
                ...
                <span className="agent-panel-item-expand-icon">
                  {isExpanded ? "−" : "+"}
                </span>
              </button>
              ...
              {isExpanded && (
                <div className="agent-panel-item-body">
                  ...
                  <div className="agent-panel-item-status">
                    <span className="agent-panel-item-status-label">
                      Status:
                    </span>
                    <span className="agent-panel-item-status-value">
                      {agent.status}
                    </span>
                    {agent.currentStage && (
                      <>
                  ...
                  {/* Error */}
                  {agent.error && (
                    <div className="agent-panel-item-error">
                      {agent.error}
                    </div>
                  )}
                </div>
