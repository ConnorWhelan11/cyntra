...
import { mockAgentRunning, mockAgentPassed, mockAgentFailed, mockAgentWithEvents } from "./fixtures";
...
describe("AgentPanel", () => {
  ...
  describe("Agent Sorting", () => {
    ...
    it("should sort by fitness when no leading/winner", () => {
      ...
      const lowFitness = { ...mockAgentPassed, fitness: 0.50 };

      const { container } = render(
        <AgentPanel
          agents={[lowFitness, highFitness]}
          isSpeculating={true}
        />
      );
