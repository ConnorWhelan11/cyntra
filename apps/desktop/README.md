...
- the selected project’s `fab/assets/viewer/` at `/viewer/` (so Godot Play mode works)
...
- “Publish” (copy/symlink) any curated exports you want visible in the static viewer under `fab/assets/viewer/assets/...`
