...
export function NavTile({
  ...
  return (
    ...
    >
      ...
      <DiamondFrame size={32} active={active} hovered={hovered} className="nav-tile-diamond" />
...
function StatusFracture() {
  return (
    <svg className="status-fracture" width="8" height="8" viewBox="0 0 8 8" aria-hidden="true">
      <path
