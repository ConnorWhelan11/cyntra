...
export function StageController({
  ...
  return (
    <>
      ...
      <directionalLight position={[-3, 2, 4]} intensity={0.5} color="#fff5e6" />

      {/* Rim light (behind, cyan tint for holodeck feel) */}
      <pointLight position={[0, 4, -5]} intensity={0.8} color="#7fdbff" distance={15} decay={2} />

      {/* Accent point light for depth */}
      <pointLight position={[-4, 1, -2]} intensity={0.3} color="#ff7fdb" distance={10} decay={2} />
