    ...
    <div className="gallery-inspector-tab-content">
      ...
      <div className="gallery-inspector-section">
        ...
        <div className="gallery-inspector-meta-row">
          ...
          <span className="gallery-inspector-world-badge">🌍 {asset.world}</span>
        </div>
      </div>
      ...
      {asset.dimensions && (
        <div className="gallery-inspector-section">
          ...
          <div className="gallery-inspector-dimensions">
            <span>
              {asset.dimensions.x.toFixed(2)} × {asset.dimensions.y.toFixed(2)} ×{" "}
      ...
      {asset.vertices && (
        <div className="gallery-inspector-section">
          ...
          <div className="gallery-inspector-stat">
            ...
            <span className="gallery-inspector-stat-value">{asset.vertices.toLocaleString()}</span>
          </div>
        </div>
      )}
      ...
      <div className="gallery-inspector-section">
        ...
        <div className="gallery-inspector-3d-status">
          {asset.has3D ? (
            <span className="gallery-inspector-status-available">✓ Available</span>
          ) : (
            <span className="gallery-inspector-status-unavailable">✗ Not available</span>
          )}
        </div>
      </div>
