...
import { PlayabilityTab } from "./PlayabilityTab";
    ...
    <div className={`gallery-inspector ${isPinned ? "pinned" : ""}`}>
      ...
      <div className="gallery-inspector-tabs" role="tablist">
        ...
        <TabButton
          ...
          label="Play"
          icon="🎮"
          isActive={activeTab === "playability"}
          onClick={() => onTabChange("playability")}
        />
        <TabButton
          id="actions"
          label="Actions"
      ...
      <div className="gallery-inspector-content" role="tabpanel">
        ...
        {activeTab === "playability" && <PlayabilityTab asset={asset} />}
        {activeTab === "actions" && (
          <ActionsTab asset={asset} onOpen={onOpenAsset} onExport={onExportAsset} />
        )}
      </div>
    </div>
  );
