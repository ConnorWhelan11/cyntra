    ...
    <div className="gallery-inspector-tab-content">
      ...
      <div className="gallery-inspector-section">
        ...
        <div className="gallery-inspector-verdict">
          {asset.gateVerdict === "pass" && (
            <span className="gallery-inspector-verdict-badge pass">✓ Pass</span>
          )}
          {asset.gateVerdict === "fail" && (
            <span className="gallery-inspector-verdict-badge fail">✗ Fail</span>
          )}
          {asset.gateVerdict === "pending" && (
            <span className="gallery-inspector-verdict-badge pending">○ Pending</span>
          )}
          {!asset.gateVerdict && (
            <span className="gallery-inspector-verdict-badge unknown">— Not evaluated</span>
          )}
        </div>
      </div>
      ...
      <div className="gallery-inspector-section">
        ...
        {hasScores ? (
              ...
              return (
                <div key={name} className="gallery-inspector-critic">
                  <div className="gallery-inspector-critic-header">
                    ...
                    <span className="gallery-inspector-critic-score" style={{ color: scoreColor }}>
          ...
          <div className="gallery-inspector-no-critics">No critic scores available</div>
        )}
      </div>
      ...
      <div className="gallery-inspector-section">
        ...
        <div className="gallery-inspector-threshold">
          {asset.passed ? (
            <span className="gallery-inspector-threshold-pass">✓ Passed threshold</span>
          ) : (
            <span className="gallery-inspector-threshold-fail">✗ Below threshold</span>
          )}
        </div>
      </div>
    </div>
