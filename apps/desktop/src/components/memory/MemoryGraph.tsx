...
export function MemoryGraph({ memories, selectedId, onSelect, className = "" }: MemoryGraphProps) {
            ...
            return (
              <g key={`${edge.source}-${edge.target}-${i}`}>
                ...
                <path
                  ...
                  markerEnd={
                    edge.type === "supersedes" || edge.type === "derived_from"
                      ? `url(#arrow-${edge.type})`
                      : undefined
                  }
            ...
            return (
              ...
              >
                ...
                <circle
                  ...
                  style={{
                    filter:
                      isSelected || isHovered ? `drop-shadow(0 0 8px ${typeConfig.color})` : "none",
                  }}
                />
