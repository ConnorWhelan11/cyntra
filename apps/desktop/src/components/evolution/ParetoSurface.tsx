...
function ParetoScene({
  ...
  const optimalPoints = useMemo(() => data.filter((p) => p.isParetoOptimal), [data]);
    ...
    <>
      ...
      <group>
        ...
        <Html position={[1.1, -0.5, -1.1]} center>
          <span className="text-[10px] text-secondary font-mono whitespace-nowrap">Quality</span>
        </Html>
        ...
        <Html position={[-1.1, 0.6, -1.1]} center>
          <span className="text-[10px] text-secondary font-mono whitespace-nowrap">Complexity</span>
        </Html>
        ...
        <Html position={[-1.1, -0.5, 1.1]} center>
          <span className="text-[10px] text-secondary font-mono whitespace-nowrap">Speed</span>
        </Html>
      </group>
          ...
          <div className="flex items-center gap-2 text-[10px] text-tertiary bg-obsidian/70 px-2 py-1 rounded">
            <span className="flex items-center gap-1">
              <span
                ...
                style={{
                  background: `rgb(${defaultColors.optimal.map((c) => c * 255).join(",")})`,
                }}
              />
              Pareto-optimal
            </span>
