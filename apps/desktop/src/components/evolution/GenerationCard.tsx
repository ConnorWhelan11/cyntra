...
export function GenerationCard({
  ...
  return (
    ...
    >
      ...
      >
        {/* Inner card content */}
        <div className="w-full h-full bg-abyss shape-cell overflow-hidden flex flex-col">
          {/* Thumbnail area */}
          <div className="flex-1 bg-void relative overflow-hidden flex items-center justify-center">
            ...
            >
              ...
              <span className="font-mono text-primary font-semibold">{generation.generation}</span>
            </div>
          ...
          <div className="p-1.5 border-t border-slate/50 bg-obsidian/50">
            <div className="flex justify-between items-center">
              ...
              <span className={`text-xs ${bestAsset.passed ? "text-success" : "text-error"}`}>
                {bestAsset.passed ? "\u2713" : "\u2717"}
              </span>
            </div>
          </div>
