...
export type SleeptimeState = "dormant" | "ingesting" | "distilling" | "consolidating" | "complete";
...
export const SleeptimeIndicator: React.FC<SleeptimeIndicatorProps> = ({
  ...
  const animationClass = state === "dormant" ? "sleeptime-breathe" : "sleeptime-pulse";
            ...
            <div className="sleeptime-stats">
              {status.patternsFound > 0 && (
                <span className="sleeptime-stat">
                  <svg className="sleeptime-stat-icon" viewBox="0 0 24 24" fill="currentColor">
