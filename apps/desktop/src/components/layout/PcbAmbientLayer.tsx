...
import React, { useMemo, useEffect, useRef, useCallback, Component, type ReactNode } from "react";
  ...
  return (
    <FieldErrorBoundary>
      <FieldProvider bus={busRef.current}>
        <FieldLayer config={config} pinToViewport={true} zIndex={0} fov={50} cameraZ={10} />
      </FieldProvider>
    </FieldErrorBoundary>
  );
}
