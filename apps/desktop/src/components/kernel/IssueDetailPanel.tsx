  ...
  return (
    <div className="mc-panel issue-detail-panel">
      ...
      <div className="issue-detail-content">
        ...
        {issue.description && <p className="issue-detail-description">{issue.description}</p>}

        {/* Action Buttons */}
        <div className="issue-detail-section">
          <div className="issue-detail-actions">
            <button type="button" className="mc-btn" onClick={() => onSetStatus(issue.id, "ready")}>
              Mark Ready
            </button>
            <button
              type="button"
            ...
            <button type="button" className="mc-btn" onClick={() => onRunIssue(issue.id)}>
              Run Issue
            </button>
            <button
              type="button"
        ...
        <div className="issue-detail-section">
          ...
          {issue.tags.filter((t) => !COMMON_TAGS.includes(t as (typeof COMMON_TAGS)[number]))
            .length > 0 && (
