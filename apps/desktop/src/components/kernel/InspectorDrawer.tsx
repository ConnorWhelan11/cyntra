    ...
    <div className="inspector-content">
      <div className="inspector-section">
        <div className="inspector-issue-header">
          ...
          <span className={`inspector-issue-status ${issue.status}`}>{issue.status}</span>
        </div>
        <h3 className="inspector-issue-title">{issue.title}</h3>
        {issue.description && <p className="inspector-issue-desc">{issue.description}</p>}
      </div>
      ...
      {relatedWorkcells.length > 0 && (
        <div className="inspector-section">
          <span className="inspector-section-label">Workcells ({relatedWorkcells.length})</span>
          <div className="inspector-workcell-list">
            {relatedWorkcells.map((wc) => (
              <div key={wc.id} className="inspector-workcell-item">
                ...
                />
                <span className="inspector-workcell-id">{wc.id.slice(-8)}</span>
      ...
      <div className="inspector-section">
        ...
        <div className="inspector-progress">
          ...
          <div className="inspector-progress-info">
            <span className="inspector-progress-value">{Math.round(progress * 100)}%</span>
            <span className={`inspector-progress-stage ${progressStage}`}>{progressStage}</span>
          </div>
        </div>
      </div>
...
function RunTabContent({
  ...
  const exitStatus =
    details.exitCode === null ? "running" : details.exitCode === 0 ? "success" : "failed";
  ...
  return (
    <div className="inspector-content">
      ...
      <div className="inspector-section">
        ...
        {details.label && <div className="inspector-run-label">{details.label}</div>}
      </div>
      ...
      <div className="inspector-section">
        ...
        <div className="inspector-stats-grid">
          ...
          <div className="inspector-stat">
            <span className="inspector-stat-value inspector-stat-success">
              {details.gatesPassed}
            </span>
            <span className="inspector-stat-label">Passed</span>
          </div>
          <div className="inspector-stat">
            <span className="inspector-stat-value inspector-stat-failed">
              {details.gatesFailed}
            </span>
    ...
    <div className="inspector-drawer">
      ...
      <div className="inspector-tab-content">
        ...
        {state.inspectorTab === "run" && (
          <RunTabContent runId={runId} projectRoot={projectRoot} onOpenTerminal={onOpenTerminal} />
        )}
      </div>
    </div>
  );
