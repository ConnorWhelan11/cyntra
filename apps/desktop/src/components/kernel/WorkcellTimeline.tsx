...
export function WorkcellTimeline({ workcells, onWorkcellClick }: WorkcellTimelineProps) {
  if (workcells.length === 0) {
    return (
      <div className="workcell-timeline">
        <div className="text-tertiary text-sm italic p-3">No workcells active</div>
      </div>
    );
  }
