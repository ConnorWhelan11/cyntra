 ...
 */
export async function listImmersaAssets(projectRoot: string): Promise<ImmersaAsset[]> {
 ...
 */
export async function loadPresentation(projectRoot: string, id: string): Promise<unknown | null> {
  try {
 ...
 */
export async function listPresentations(projectRoot: string): Promise<string[]> {
 ...
 */
export async function deletePresentation(projectRoot: string, id: string): Promise<void> {
