  ...
  return (
    <div className="stage-controls">
      ...
      <div className="stage-controls-status">
        {status === "loading" && <span className="stage-status loading">Loading...</span>}
        {status === "running" && <span className="stage-status running">Running</span>}
        {status === "error" && <span className="stage-status error">Error</span>}
