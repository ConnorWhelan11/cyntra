  ...
  return (
    ...
    >
      ...
      <div className="marker-popover-header">
        <span className="marker-popover-type" style={{ background: typeColor }}>
          {typeLabel}
        </span>
      ...
      <div className="marker-popover-content">
        ...
        {!marker.data && (
          <div className="marker-popover-empty">No data available for this marker</div>
        )}
      </div>
    ...
    <>
      ...
      {entity.dialogue && (
        <div className="marker-detail">
          ...
          <div className="marker-detail-value marker-detail-value--muted">{entity.dialogue}</div>
        </div>
      )}
    </>
  );
    ...
    <>
      ...
      {entity.description && (
        <div className="marker-detail">
          ...
          <div className="marker-detail-value marker-detail-value--muted">{entity.description}</div>
        </div>
      )}
    </>
  );
    ...
    <>
      ...
      {trigger.marker && (
        <div className="marker-detail">
          ...
          <div className="marker-detail-value marker-detail-value--muted">{trigger.marker}</div>
        </div>
      )}
      <div className="marker-detail">
      ...
      {trigger.actions && trigger.actions.length > 0 && (
        <div className="marker-detail">
          <div className="marker-detail-label">Actions ({trigger.actions.length})</div>
          <div className="marker-detail-list">
            ...
            {trigger.actions.length > 3 && (
              <span className="marker-detail-tag">+{trigger.actions.length - 3}</span>
            )}
          </div>
        </div>
      )}
