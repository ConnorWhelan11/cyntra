  ...
  return (
    <Panel style={{ height: "100%" }}>
      <PanelHeader
        ...
        actions={
          <div className="row">
            ...
            {activeSession && <Button onClick={() => killTerminal(activeSession.id)}>Kill</Button>}
          </div>
        }
      />
      ...
      <div className="split">
        {/* Session List */}
        <div className="list">
          {sessions.length === 0 && <div className="list-item muted">No sessions yet.</div>}
          {sessions.map((s) => (
            <div
              key={s.id}
            ...
            >
              <div style={{ fontWeight: 650 }}>{s.command ?? "shell"}</div>
        ...
        <div className="detail">
          <div className="panel-header">
            ...
            <div className="muted">{activeSessionId ? activeSessionId : "—"}</div>
          </div>
