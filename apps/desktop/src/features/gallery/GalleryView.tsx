  ...
  return (
    <div className="h-full flex flex-col">
      ...
      <div className="flex items-center justify-between mb-4">
        <h1 className="text-2xl font-semibold text-primary tracking-tight">GALLERY</h1>
      ...
      <div className="flex-1 grid grid-cols-12 gap-4 min-h-0">
        ...
        <div className="col-span-4 mc-panel flex flex-col min-h-0">
          <div className="mc-panel-header">
            ...
            {selectedAsset && (
              <button className="mc-btn text-xs" onClick={() => setViewerAsset(selectedAsset)}>
                Full View
              </button>
            )}
          </div>
          <div className="flex-1 overflow-auto">
            {selectedAsset ? (
              <AssetViewer asset={selectedAsset} onClose={() => setSelectedAssetId(null)} />
            ) : (
              <div className="h-full flex items-center justify-center text-tertiary">
                <div className="text-center">
