...
import { Graph3D } from "@oos/ag-ui-ext";
import type {
  GraphSnapshot,
  GraphNode,
  GraphEdge,
    ...
    <div className="objectives-tab">
      ...
      <div className="objectives-toolbar">
        ...
        <div className="objectives-toolbar-right">
          <button className="objectives-toolbar-btn" onClick={handleZoomToFit} title="Zoom to fit">
            ⤢ Zoom to Fit
          </button>
          <button
      ...
      <div className="objectives-canvas">
        {objectives.length === 0 ? (
          <div className="objectives-empty">
            ...
            <p className="objectives-empty-hint">Add objectives to define the quest structure</p>
          </div>
        ) : (
          <Canvas
      ...
      <div className="objectives-legend">
        ...
        <div className="objectives-legend-items">
          <div className="objectives-legend-item">
            <span className="objectives-legend-dot" style={{ background: getTypeColor("main") }} />
            <span>Main Quest</span>
          </div>
          <div className="objectives-legend-item">
            <span className="objectives-legend-dot" style={{ background: getTypeColor("side") }} />
          ...
          <div className="objectives-legend-item">
            <span className="objectives-legend-dot" style={{ background: getTypeColor("final") }} />
            <span>Final</span>
          </div>
          ...
          <div className="objectives-legend-item">
            <span className="objectives-legend-status objectives-legend-status--active">◐</span>
            <span>Active</span>
          </div>
          <div className="objectives-legend-item">
            <span className="objectives-legend-status objectives-legend-status--locked">○</span>
            <span>Locked</span>
          </div>
        </div>
      </div>
