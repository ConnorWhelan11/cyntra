...
const MOCK_MEMORIES: MemoryItem[] = [
  {
    ...
    importance: 0.89,
    content:
      "When fixing auth bugs in FastAPI, check middleware order first. Common issue: token expiry handler runs after validation.",
    sourceRun: "89",
    sourceIssue: "38",
    accessCount: 12,
  ...
  },
  {
    ...
    importance: 0.72,
    content:
      "pytest-asyncio fixtures cannot be used with regular pytest fixtures in the same test. Use @pytest.mark.asyncio decorator.",
    sourceRun: "76",
    sourceIssue: "31",
    accessCount: 5,
  ...
  },
  {
    ...
    importance: 0.65,
    content:
      "This codebase uses FastAPI with SQLAlchemy async. Database session should be obtained from request.state.db.",
    accessCount: 28,
  ...
  },
  {
    ...
    importance: 0.55,
    content:
      "Blender scripts should import bpy at the top level, not inside functions, to avoid module reloading issues.",
    sourceRun: "92",
    sourceIssue: "44",
    accessCount: 3,
  ...
  },
  {
    ...
    importance: 0.78,
    content:
      "Project uses pnpm workspaces for monorepo management. Always run pnpm install from root directory.",
    accessCount: 15,
    createdAt: "1 day ago",
    links: [{ type: "related_to", targetId: "mem-004", targetTitle: "Blender script patterns" }],
  },
  {
    id: "mem-006",
    type: "failure",
    ...
    importance: 0.82,
    content:
      "React useState with objects: spread operator creates shallow copy only. Deep nested updates require immer or manual deep clone.",
    sourceRun: "95",
    sourceIssue: "47",
    accessCount: 8,
        ...
        <div className="text-center space-y-4">
          ...
          <div className="relative mx-auto w-24 h-24">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <svg
                className="w-10 h-10 text-accent-primary/60"
                viewBox="0 0 24 24"
                fill="none"
                stroke="currentColor"
                strokeWidth="1.5"
    ...
    <div className="h-full flex flex-col gap-4">
      ...
      <header className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          <h1 className="text-2xl font-semibold text-primary tracking-tight">MEMORY</h1>
