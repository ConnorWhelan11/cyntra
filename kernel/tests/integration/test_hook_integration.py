...
class TestHookRunnerConfig:
    ...
    def test_get_hook_config_returns_dataclass_as_dict(self, sample_config: KernelConfig) -> None:
    ...
    def test_get_hook_config_returns_empty_for_unknown(self, sample_config: KernelConfig) -> None:
...
class TestVerifierHookIntegration:
    ...
    def test_gate_failure_triggers_debug_hooks(
        ...
        sample_proof.verification = {
            "all_passed": False,
            "gates": {"test": {"passed": False, "stderr": "AssertionError: expected 1, got 2"}},
        }
