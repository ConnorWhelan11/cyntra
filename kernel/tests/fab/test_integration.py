...
def _subprocess_env() -> dict[str, str]:
    env = dict(os.environ)
    src_root = str(REPO_ROOT / "kernel" / "src")
...
class TestFabIntegration:
    ...
    def test_gate_config_loads(self, gate_config):
        ...
        from cyntra.fab.config import load_gate_config
    ...
    def test_geometry_critic_evaluates_asset(self, test_asset, temp_dir):
        ...
        if importlib.util.find_spec("trimesh") is None:
            pytest.skip("trimesh not installed (kernel[fab] extra required)")

        from cyntra.fab.critics.geometry import GeometryCritic
    ...
    def test_category_critic_evaluates_renders(self, temp_dir):
        ...
        from cyntra.fab.critics.category import CategoryCritic
    ...
    def test_gate_dry_run_produces_valid_output(self, test_asset, gate_config, temp_dir):
    ...
    def test_schema_validation(self):
        ...
        schemas_dir = REPO_ROOT / "kernel" / "schemas" / "fab"
    ...
    def test_archive_preserves_nested_structure(self, temp_dir):
        ...
        assert (archive_path / "logs" / "fab" / "fab-realism" / "render_output.png").exists()
...
class TestFabModuleImports:
    ...
    def test_critics_import(self):
        """Test critics import."""
        from cyntra.fab.critics import (
            CategoryCritic,
            GeometryCritic,
        )
    ...
    def test_config_find_gate_config(self):
        ...
        from cyntra.fab.config import find_gate_config
