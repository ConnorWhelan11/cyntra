...
from cyntra.memory.trinkets.base import RunContext
...
class TestPatternsTrinket:
    ...
    @pytest.mark.asyncio
    async def test_generate_content_with_patterns(self, trinket, mock_store, mock_vector_ops):
...
class TestPlaybookTrinket:
    ...
    @pytest.mark.asyncio
    async def test_generate_content_with_playbooks(self, trinket, mock_store, mock_vector_ops):
