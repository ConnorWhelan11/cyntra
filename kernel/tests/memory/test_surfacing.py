...
from cyntra.memory.models import AgentMemory, MemoryScope, MemoryType
...
class TestSurfacingConfig:
    ...
    def test_weights_sum_to_one(self):
        ...
        total = config.semantic_weight + config.tag_weight + config.file_weight + config.link_weight
...
class TestMemorySurfacingService:
    ...
    @pytest.mark.asyncio
    async def test_get_relevant_memories_semantic(self, service, mock_store, sample_memories):
    ...
    @pytest.mark.asyncio
    async def test_get_relevant_memories_by_tags(self, service, mock_store, sample_memories):
    ...
    @pytest.mark.asyncio
    async def test_get_relevant_memories_by_files(self, service, mock_store, sample_memories):
    ...
    @pytest.mark.asyncio
    async def test_get_relevant_memories_combined(self, service, mock_store, sample_memories):
    ...
    @pytest.mark.asyncio
    async def test_get_relevant_memories_with_limit(self, service, mock_store, sample_memories):
...
class TestGenerateFingerprint:
    ...
    async def test_generate_fingerprint(self, service):
        ...
        fingerprint, embedding = await service.generate_fingerprint("Test query text")
...
class TestExpandViaLinks:
    ...
    @pytest.mark.asyncio
    async def test_expand_via_links_with_results(self, service, mock_linking_service):
