...
class TestSleeptimePipeline:
    ...
    @pytest.mark.asyncio
    async def test_consolidation_with_similar_memories(self, mock_store, mock_vector_ops):
        ...
        mock_store.pool.acquire.return_value.__aenter__ = AsyncMock(return_value=mock_conn)
