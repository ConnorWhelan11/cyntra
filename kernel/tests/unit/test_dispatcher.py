...
from cyntra.kernel.config import GatesConfig, KernelConfig
...
class TestDispatcher:
    ...
    async def test_dispatch_async_respects_timeout_override(
        ...
        class StubAdapter:
            ...
            async def execute(
                self, manifest: dict, workcell_path: Path, timeout: timedelta
            ) -> PatchProof:
...
class TestManifestWriting:
    ...
    def test_writes_manifest_to_workcell(self, config: KernelConfig, tmp_path: Path) -> None:
