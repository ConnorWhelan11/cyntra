...
from cyntra.adapters import ClaudeAdapter, CodexAdapter, CrushAdapter, get_adapter
...
class TestCrushAdapter:
    ...
    def test_init_default_config(self) -> None:
        ...
        assert (
            "claude" in adapter.default_model.lower() or "sonnet" in adapter.default_model.lower()
        )
