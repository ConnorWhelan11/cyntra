...
All Fab artifacts use JSON Schema (draft-07) for validation. Schemas live in `kernel/schemas/fab/` and follow existing kernel conventions.
...
**File**: `kernel/schemas/fab/asset-proof.schema.json`
...
**File**: `kernel/schemas/fab/critic-report.schema.json`
...
**File**: `kernel/schemas/fab/gate-verdict.schema.json`
    ...
    "next_actions": {
      ...
      "items": {
        ...
        "properties": {
          "action": {
            "type": "string",
            "enum": ["repair", "rerender_vote_pack", "fallback_to_template", "human_review"]
          },
...
**File**: `kernel/schemas/fab/run-manifest.schema.json`
...
```json
{
  ...
  "type": "object",
  "required": ["schema_version", "run_id", "created_at", "files", "tool_versions"],
  "properties": {
    "schema_version": { "type": "string", "const": "1.0" },
    "run_id": { "type": "string" },
