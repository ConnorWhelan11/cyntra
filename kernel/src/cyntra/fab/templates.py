...
class TemplateConstraints:
    ...
    bounds_m: dict[str, tuple[float, float]] | None = None
...
class TemplateRegistry:
    ...
    def _load_registry(self) -> None:
        ...
        try:
            ...
            logger.info(
                f"Loaded template registry with {len(self._registry_data.get('templates', []))} templates"
            )
    ...
    def _load_template_manifest(self, registry_entry: dict[str, Any]) -> TemplateManifest | None:
        ...
        constraints = TemplateConstraints(
            ...
            bounds_m={k: tuple(v) for k, v in bounds_data.items()} if bounds_data else None,
        )
    ...
    def find_template_for_category(self, category: str) -> TemplateManifest | None:
...
class TemplateChecker:
    ...
    def check_adherence(
        self,
        asset_bounds: dict[str, float] | None = None,
        asset_parts: list[str] | None = None,
...
def get_template_registry(templates_root: Path | None = None) -> TemplateRegistry:
