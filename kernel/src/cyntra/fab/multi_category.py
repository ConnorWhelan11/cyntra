...
def detect_category_from_tags(tags: list[str]) -> str | None:
    """
...
def get_category_config(category: str) -> CategoryConfig | None:
...
def route_to_gate(
    ...
    explicit_gate_config: str | None = None,
) -> tuple[str, str]:
    """
...
class MultiCategoryGateRouter:
    ...
    def get_scene_refs(self, category: str) -> tuple[str | None, str | None]:
        """
