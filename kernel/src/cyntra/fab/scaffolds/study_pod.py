...
class StudyPodScaffold(ScaffoldBase):
    ...
    def generate_blender_script(
        ...
        return self._generate_blender_script(params, output_path, output_path.with_suffix(".blend"))
    ...
    def generate_script(
        ...
        script_content = self._generate_blender_script(final_params, output_glb, output_blend)
