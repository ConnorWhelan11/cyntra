...
chmod +x kernel/src/cyntra/skills/**/*.py
...
kernel/src/cyntra/skills/development/cyntra-schema-validator.py \
...
# Add skill to path
sys.path.insert(0, "kernel/src/cyntra/skills/development")
...
sys.path.extend([
    "kernel/src/cyntra/skills/development",
    "kernel/src/cyntra/skills/dynamics",
])
...
# Verify workcell
kernel/src/cyntra/skills/development/workcell-lifecycle.py verify --workcell-id wc-42-20251220T190000Z

# ... do work in workcell ...

# Run quality gates
kernel/src/cyntra/skills/development/quality-gate-runner.py \
  .workcells/wc-42-20251220T190000Z/ \
...
# Analyze trajectory
kernel/src/cyntra/skills/development/trajectory-analyzer.py \
  .workcells/wc-42-20251220T190000Z/rollout.json \
  --transitions
```
...
# Ingest rollout
kernel/src/cyntra/skills/dynamics/cyntra-dynamics-ingest.py \
  .workcells/wc-42-20251220T190000Z/rollout.json \
...
kernel/src/cyntra/skills/dynamics/potential-fitter.py \
  .cyntra/dynamics/transition_matrix.json \
  --output .cyntra/dynamics/potential.json

# Calculate action
kernel/src/cyntra/skills/dynamics/action-metric-calculator.py \
  .workcells/wc-42-20251220T190000Z/rollout.json \
  .cyntra/dynamics/transition_matrix.json \
...
```bash
# Create mutation
kernel/src/cyntra/skills/evolution/genome-mutator.py \
...
kernel/src/cyntra/skills/evolution/pareto-frontier-updater.py \
...
kernel/src/cyntra/skills/evolution/exploration-controller.py \
...
kernel/src/cyntra/skills/fab/blender-deterministic-render.py \
...
```bash
# Run gate
kernel/src/cyntra/skills/fab/fab-gate-evaluator.py \
...
kernel/src/cyntra/skills/fab/deterministic-world-builder.py \
...
/Users/connor/Medica/glia-fab/kernel/src/cyntra/skills/development/cyntra-rollout-builder.py ...
```
