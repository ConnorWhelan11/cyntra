...
Usage:
    python kernel/src/cyntra/skills/generate.py              # Generate all skills
    python kernel/src/cyntra/skills/generate.py --clean      # Clean and regenerate
    python kernel/src/cyntra/skills/generate.py --dry-run    # Show what would be generated
"""
    ...
    if not dry_run:
        ...
        if not gitignore.exists():
            gitignore.write_text(
                "# Generated files - regenerate with: python kernel/src/cyntra/skills/generate.py\n"
            )
