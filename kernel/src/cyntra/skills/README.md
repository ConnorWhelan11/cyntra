...
python kernel/src/cyntra/skills/generate.py

# Clean and regenerate
python kernel/src/cyntra/skills/generate.py --clean

# Preview without writing
python kernel/src/cyntra/skills/generate.py --dry-run
```
...
.claude/skills/           # Claude Code discovery (generated)
  skill-name/
    ...
    scripts/
      main.py → symlink   # Links to kernel/src/cyntra/skills/{category}/skill-name.py
...
| **Cyntra Kernel**       | YAML (structured)   | `kernel/src/cyntra/skills/{category}/` |
...
1. Create `skill-name.yaml` in `kernel/src/cyntra/skills/<category>/`
2. Implement the skill logic in `skill-name.py`
3. Add examples showing typical usage
4. Run `python kernel/src/cyntra/skills/generate.py` to generate SKILL.md
