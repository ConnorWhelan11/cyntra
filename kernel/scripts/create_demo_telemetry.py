...
"""
        ...
        telemetry.tool_call(
            tool="Read",
            args={"file_path": "fab/assets/blender/generate_template.py"},
        )
        await asyncio.sleep(0.1)
        ...
        telemetry.tool_call(
            tool="Write",
            args={"file_path": "fab/assets/blender/generate_walkable_library.py"},
        )
        await asyncio.sleep(0.1)
        ...
        telemetry.tool_call(
            tool="Bash",
            args={
                "command": "blender --background --python fab/assets/blender/generate_walkable_library.py"
            },
        )
    ...
    print("Demo telemetry created successfully!")
